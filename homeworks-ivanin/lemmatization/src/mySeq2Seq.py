...
from allennlp.training.metrics import BLEU, BooleanAccuracy


@Model.register("my_simple_seq2seq")
class SimpleSeq2Seq(Model):
    ...
    def __init__(self,
        ...
        self._bool_accuracy = BooleanAccuracy()
    ...
    def get_metrics(self, reset: bool = False) -> Dict[str, float]:
        ...
        if self._bleu and not self.training:
            ...
            all_metrics.update({"bool_acc" : self._bool_accuracy.get_metric(reset=reset)})
        return all_metrics