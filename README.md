...
- [Морфологический синтез](#Мофрологический-синтез)
<!-- /TOC -->
...
При этом при поиске основы проходим слева направо, а для оконачания - справа налево: <span style="text-decoration:overline">КОТ</span><u>ОМ</u>
...
- Композиты: пар<span style="color:red">о</span>воз<span style="color:red">о</span>строение, Петропавловск-Камчатский. <span style="color:red">г.</span>Москва
...
- Незнакомые слова - пытаемся подогнать парадигму под какое-нибудь знакомое слово. Пример: заддосить:
  -  Выделяются всевозможные окончания:
     ...
     - заддосит<span style="color:red">ь</span>(как в "феврал<span style="color:red">ь</span>")
     - заддоси<span style="color:red">ть</span>(как в "закоси<span style="color:red">ть</span>")
 ...
 - Омонимия: Эти виды <span style="color:red">стали</span> у многих <span style="color:red">стали</span> пользоваться популярностью.
...
Описание работы [тут](https://cache-mskmar06.cdn.yandex.net/download.yandex.ru/company/iseg-las-vegas.pdf).
Данный морфологический анализатор расчитан на максимальное быстродействие для использования в поисковом движке. Поэтому о каких-то серьёзных использованиях контекста речи не идет.
